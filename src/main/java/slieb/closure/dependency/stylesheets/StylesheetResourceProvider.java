...
public class StylesheetResourceProvider implements ResourceProvider {
    ...
    private static final StylesheetDependencyParser parser = new StylesheetDependencyParser();

    private DependencyResourceProvider dependencyResourceProvider;

    public StylesheetResourceProvider(final @Nonnull ResourceProvider resourceProvider,
